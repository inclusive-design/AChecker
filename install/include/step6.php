...
if (isset($_POST['submit'])) {
	...
	if ($_POST['log_yes']) {
		...
		if ($_POST['step1']['old_path'] != '') {
			...
			$db     = @mysqli_connect($_POST['step1']['db_host'] . ':' . $_POST['step1']['db_port'], $_POST['step1']['db_login'], urldecode($_POST['step1']['db_password']));
	...
	<tr>
		...
		<td class="row1"><?php
			...
			if ($_POST['step1']['old_path'] != '') {
				...
				$db     = @mysqli_connect($_POST['step2']['db_host'] . ':' . $_POST['step2']['db_port'], $_POST['step2']['db_login'], $_POST['step2']['db_password']);
			}
