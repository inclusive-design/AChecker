...
UPDATE `language_text` SET text = replace(text, 'Web site engine\'s code is copyright &copy; 2011', 'Web site engine\'s code is copyright &copy; 2018') WHERE text = '%Web site engine\'s code is copyright &copy; 2011%';
