...
<form  id="input_form" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
		<div  class="input-form" id="right-input-form">
			...
			<div id="general-option">
				 <fieldset class="group_form"><legend class="group_form">Generale</legend>						
					...
					<div class="general-option-row">
						...
						<label for='css_disable'>Disabilita la verifica dei CSS </label><a class="req_link" href="<?php echo $this->base_path ?>documentation_vamola/css_disable_info.php" title="Visualizza le informazioni su questa opzione"><img  src="images/bookd.gif" alt="Informazioni sull'opzione 'Disabilita la verifica dei CSS'" /></a>
						...
						?>
						/>
						<label for='visual_img'>Controllo visivo alternativa testuale </label><a class="req_link" href="<?php echo $this->base_path ?>documentation_vamola/visual_img_info.php" title="Visualizza le informazioni su questa opzione"><img  src="images/bookd.gif" alt="Informazioni sull'opzione 'Controllo visivo alternativa testuale'" /></a>
				...
				<div id="requisiti">
					...
					?>
								...
								<input <?php  if( $i==8 || $i==9 || $i==12 || $i==14 || $i==15 || $i==16 || $i==18 || $i==19 || $i==21) echo('disabled="disabled"');?> type="checkbox" name="req[]" <?php echo('id="req_'.($i+1).'" value="'.$requisiti[$i].'"') ?> 
									...
									?> />
								<label for='req_<?php echo($i+1)?>'>Requisiti 7 e 8</label> <a class="req_link" href="<?php echo $this->base_path ?>documentation_vamola/requisiti.php#req_<?php echo($i+1)?>" title="Visualizza il testo dei Requisiti 7 e 8"><img  src="images/bookd.gif" alt="Testo dei requisiti 7 e 8" /></a>
								</div>		
							...
							?>
								...
								<input <?php if($i==8 || $i==9 || $i==12 || $i==14 || $i==15 || $i==16 || $i==18 || $i==19 || $i==21) echo('disabled="disabled"');?>  type="checkbox" name="req[]" <?php echo('id="req_'.($i+1).'" value="'.$requisiti[$i].'"') ?> 
									...
									?> />
								<label for='req_<?php echo($i+1)?>'>Requisito <?php echo($i+1)?></label> <a class="req_link" href="<?php echo $this->base_path ?>documentation_vamola/requisiti.php#req_<?php echo($i+1)?>" title="Visualizza il testo del Requisito <?php echo($i+1)?>"><img  src="images/bookd.gif" alt="Testo del requisito <?php echo($i+1)?>" /></a>
								</div>
					<?php	
							}
		...
		<div  class="input-form" id="left-input-form">			
...
<!--			</div>-->
		<!--	<div class="row-input">-->
					...
					<input type="file" id="check_file" name="uploadfile" size="30"/>
					...
					<div style="float:left;padding:1%;text-align:left;"><!-- prova colonna sinistra-->
						...
						<input  type="checkbox" name="gid[]" id='guid_10' value='10' 
							...
							<?php 
									...
									if (isset ($_POST['gid']) && in_array(10, $_POST["gid"]))
										echo 'checked="checked"'; 
						...
						<input  type="checkbox" name="gid[]" id='guid_7' value='7' 
							<?php 
									if (isset ($_POST['gid']) && in_array(7, $_POST["gid"]))
										echo 'checked="checked"'; 
							?> />
						...
						<input  type="checkbox" name="gid[]" id='guid_8' value='8' 
							<?php 
									if (isset ($_POST['gid']) && in_array(8, $_POST["gid"]))
										echo 'checked="checked"'; 
							?> />
						...
						<input  type="checkbox" name="gid[]" id='guid_9' value='9' 
							<?php 
									if (isset ($_POST['gid']) && in_array(9, $_POST["gid"]))
										echo 'checked="checked"'; 
							?> />
