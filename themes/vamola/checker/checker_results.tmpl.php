...
if (isset($this->error)) echo $this->error;
	...
	$link_home = "
			<div style='margin-left:60px; margin-right:60px; margin-bottom:10px; padding-bottom:1px; text-align:left; '>
				...
				href='".$_SERVER['PHP_SELF']."'><img style='border:none; height: 10px; width: 10px; padding-right:3px' src='images/arrow-left.png' alt='' />Esegui una nuova validazione</a>
			</div>
		";
...
?>
	...
	<?php
//	if (isset($_SESSION["show_nav"]))
//	{
//		echo ('
//	
//			<div style="margin-left:20px;";>
//					Visualizza risultati di validazione:
//					<a href="/checker/index.php?show=all&tab_ris=1" accesskey="2" >Tutti</a>
//					<a href="/checker/index.php?show=stanca&tab_ris=1" accesskey="2" >Legge 04/2004 (Stanca)</a>
//					<a href="/checker/index.php?show=wcag&tab_ris=5" accesskey="2" >WCAG 2.0</a>
//					<a href="/checker/index.php?show=alternative&tab_ris=8" accesskey="2" >Alternativa</a>
//			</div>	
//		');
//	}
	?>
...
//					<li><a href="/checker/index.php?tab_ris=1" accesskey="1" title="'. _AC("errors_10"). 'Alt+1" id="menu_errors_10" >'. _AC("errors_10") .' <span class="small_font">('. ($this->num_of_errors_10 + $_SESSION[risultati]["num_of_html_errors"] + $_SESSION[risultati]["num_of_css_errors"]) .')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=2" accesskey="2" title="'. _AC("errors_11").' Alt+2" id="menu_errors_11" >'. _AC("errors_11").' <span class="small_font">('. ($this->num_of_errors_11 + 0) . ')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=3" accesskey="3" title="'. _AC("errors_12").' Alt+3" id="menu_errors_12" >'. _AC("errors_12").' <span class="small_font">('. ($this->num_of_errors_12 + 0) . ')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=4" accesskey="4" title="'. _AC("errors_13").' Alt+4" id="menu_errors_13" >'. _AC("errors_13").' <span class="small_font">('. ($this->num_of_errors_13 + 0) . ')</span></a></li>
//				</ul>
//				
//				<ul class="topnavlist" id="topnavlist_bottom">
//					<li><a href="/checker/index.php?tab_ris=5" accesskey="5" title="'. _AC("known_problems") .' Alt+5" id="menu_errors">'.  _AC("known_problems").' (WCAG 2.0) <span class="small_font">('.$this->num_of_errors.')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=6" accesskey="6" title="'. _AC("known_problems") .' Alt+6" id="menu_errors">'.  _AC("likely_problems").' (WCAG 2.0) <span class="small_font">('.$this->num_of_likely_problems.')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=7" accesskey="7" title="'. _AC("known_problems") .' Alt+7" id="menu_errors">'.  _AC("potential_problems").' (WCAG 2.0) <span class="small_font">('. $this->num_of_potential_problems.')</span></a></li>
//				</ul>
//			');
//		}
...
//			echo('
//				<ul class="topnavlist" id="topnavlist_up">
//					<li><a href="/checker/index.php?tab_ris=5" accesskey="5" title="'. _AC("known_problems") .' Alt+5" id="menu_errors">'. _AC("known_problems").' <span class="small_font">('.$this->num_of_errors.')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=6" accesskey="6" title="'. _AC("known_problems") .' Alt+6" id="menu_errors">'. _AC("likely_problems").' <span class="small_font">('.$this->num_of_likely_problems.')</span></a></li>
//					<li><a href="/checker/index.php?tab_ris=7" accesskey="7" title="'. _AC("known_problems") .' Alt+7" id="menu_errors">'. _AC("potential_problems").' <span class="small_font">('. $this->num_of_potential_problems.')</span></a></li>
//				</ul>
//			');
//		}
...
<!--	Risultati multipli	
		<ul class="navigation">
			<li class="navigation"><a href="checker/index.php?tab_ris=8" accesskey="8" title="Mixed 1 Alt+8" id="menu_mixed_1"><span> Errori congiunti 1 (<?php echo $this->num_of_errors_10 + $this->num_of_html_errors + $this->num_of_css_errors + $this->num_of_errors ; ?>)</span></a></li>
			<li class="navigation"><a href="checker/index.php?tab_ris=9" accesskey="9" title="Mixed 2 Alt+9" id="menu_mixed_2"><span> Errori congiunti 2 (<?php echo $this->num_of_errors_11 + $this->num_of_likely_problems ; ?>)</span></a></li>
			<li class="navigation"><a href="checker/index.php?tab_ris=10" accesskey="10" title="Mixed 3 Alt+10" id="menu_mixed_3"><span> Errori congiunti 3 (<?php echo $this->num_of_errors_12 + $this->num_of_potential_problems ; ?>)</span></a></li>
			<li class="navigation"><a href="checker/index.php?tab_ris=11" accesskey="11" title="Mixed 4 Alt+11" id="menu_mixed_4"><span> Errori congiunti 4 (<?php echo $this->num_of_errors_13 + 0 ; ?>)</span></a></li>
...
<?php
	...
	if (isset($this->htmlValidator))
	{
		...
		{
			// Se è settata la chiamata al validatore ha dato errori
