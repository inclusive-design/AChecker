...
$sql	= "SELECT * FROM AC_language_text WHERE language_code='en' ORDER BY `variable`, `term`";
...
while($row = mysql_fetch_assoc($result)) {
	...
	$text .= "INSERT INTO `language_text` VALUES ('en', '$row[variable]','$row[term]','$row[text]','$row[revised_date]','$row[context]');\n";
}
