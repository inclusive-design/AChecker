...
if(!isset($_POST["validate_uri"]) &&  !isset($_POST["validate_file"]) && !isset($_GET["tab_ris"]) && !isset($_POST["all_checks"]) && !isset($_POST["no_checks"]))
{
...
//abilito i validatori html e css se il req 1 ï¿½ selezionato
...
if(isset($_POST['gid']) && in_array(7, $_POST["gid"]) && !in_array(7, $_SESSION["gid"]))
	$_SESSION["gid"][]= 7;


if(isset($_POST['gid']) && in_array(8, $_POST["gid"]) && !in_array(8, $_SESSION["gid"]))
	$_SESSION["gid"][]= 8;		
	

if(isset($_POST['gid']) && in_array(9, $_POST["gid"]) && !in_array(9, $_SESSION["gid"]))
	$_SESSION["gid"][]= 9;

if(isset($_POST['gid']) && in_array(10, $_POST["gid"]) && !in_array(10, $_SESSION["gid"]))
	$_SESSION["gid"][]= 10;		
...
//MB se non è selezionato il checkbox "Legge Stanca" elimino gli eventuali check memorizzati nella sessione (in modo che non vengano eseguiti)
if(isset($_SESSION['gid']) && !in_array(10, $_SESSION["gid"]))
	$_SESSION["req"]= array();
...
// Restituisce true se il nome del file non ï¿½ vuoto e se non ï¿½ composto unicamente da http://
