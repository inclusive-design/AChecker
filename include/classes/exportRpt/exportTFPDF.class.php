...
class acheckerTFPDF extends tFPDF {
	...
	*/
	...
	{	
		...
		$this->AddFont('DejaVu',  '',  'HelveticaSansCondensed.ttf', true);
		// $this->AddFont('DejaVu', 'B',  'HelveticaSansCondensed-Bold.ttf', true);
		// $this->AddFont('DejaVu', 'I',  'HelveticaSansCondensed-Oblique.ttf', true);
		// $this->AddFont(DejaVu', 'BI', 'HelveticaSansCondensed-BoldOblique.ttf', true);
