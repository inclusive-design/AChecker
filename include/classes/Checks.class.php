...
//b, basefont, big, center, font, s, small, strike, tt, u: pseudo 2
	...
	//nota MB: non Ã¨ sufficiente restituire un messaggio per pagina invece che per ogni elemento con attributo style?
	...
	$i=0;
		...
		for($i=0;$i<$num-1;$i++){
			...
			//if(substr($m_bottom,strlen($m_bottom),-2)!="em" || substr($p_bottom,strlen($p_bottom),-2)!="em" || substr($m_top,strlen($m_top),-2)!="em" || substr($p_top,strlen($p_top),-2)!="em"){
				...
				//MB"
				//echo ("<p>Ã¨ un EM -->".substr($m_bottom,-2, 2)."</p>");
...
//Pseudocodice 7.5
	...
	*/
	...
	//  per cui c'ï¿½ giï¿½ il controllo 3018)
	...
	**************/
	...
	public static function check_14002($e, $content_dom)
	{
		...
		{		/*
		//MB tolgo eventuali nomi di proprietÃ 
