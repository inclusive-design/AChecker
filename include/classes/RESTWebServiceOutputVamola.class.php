...
//MB xml per il monitor
	...
	*/
	function RESTWebServiceOutputVamola($num_success, $errors, $userLinkID, $guidelineArray)
	{
//		debug($errors);exit;
		$this->errors = $errors;
		//MB
	...
	private function getIdReq($id)
	{
		...
		{
			echo("<p>". $i.": non è associato a nessun requisito</p>");	
	...
	private function getIdGroup($id)
	{
		...
		else 
		{
			...
			echo("<p>". $i.": non è associato a nessun gruppo</p>");	
