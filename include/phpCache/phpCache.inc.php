...
/*
   ...
   June 2015: Customized by Cindy Li (cli@ocadu.ca) to remove the use
   of references in function declarations that is no longer supported
   in PHP 5.4+ since the latest phpCache library hasn't been upgraded
   for this support.
   TODO: Upgrade phpCache library once it supports the latest PHP version.
*/
